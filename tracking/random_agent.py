...
if __name__ == '__main__':
    ...
    from tracking.envs.tracking_env import TrackingEnv, TrackingEnvSpline
    ...
    env_config = dict(experiment_name=experiment_name,
                      ...
                      visualize_action_spline=args.visualize_action_spline,
